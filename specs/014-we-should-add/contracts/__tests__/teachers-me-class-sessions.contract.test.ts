...
vi.mock("@/auth", () => ({
  auth: vi
    .fn()
    .mockResolvedValue({ user: { id: "u-teacher", role: "TEACHER" } }),
}));
...
describe("GET /api/teachers/me/class-sessions (classTypeIds filter)", () => {
  ...
  it("applies exact-match IN filter when classTypeIds is provided", async () => {
    ...
    const url =
      "http://localhost/api/teachers/me/class-sessions?startDate=2025-01-01&endDate=2025-01-07&classTypeIds=a,b";
