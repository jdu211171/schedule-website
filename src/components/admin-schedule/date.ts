/**
 * Date utility functions for admin schedule
 * Fixed version to prevent timezone-related date shifting issues
 */
...
/**
 * FIXED: Gets a date key for lookups and comparisons (YYYY-MM-DD)
 * Uses local date methods to avoid timezone offset issues
 * @param date Date object
...
/**
 * OLD VERSION (for reference): Gets a date key using UTC
 * This version can cause date shifting in timezones ahead of UTC
 * @param date Date object
 * @returns Date key string
 */
...
/**
 * Debug function to compare date conversion methods
