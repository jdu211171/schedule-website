          ...
          <div className="space-y-4">
            <div>
              ...
              <Row
                ...
                onChange={(v) =>
                  setConfig({ ...config, markTeacherUnavailable: v })
                }
              />
              <Row
                ...
                onChange={(v) =>
                  setConfig({ ...config, markStudentUnavailable: v })
                }
              />
              <Row
                ...
                onChange={(v) =>
                  setConfig({ ...config, markTeacherWrongTime: v })
                }
              />
              <Row
                ...
                onChange={(v) =>
                  setConfig({ ...config, markStudentWrongTime: v })
                }
              />
              <Row
