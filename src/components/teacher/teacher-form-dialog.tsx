            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className="flex justify-between items-center w-full">
                ...
                <div className="flex gap-3">
                  ...
                  {keepDialogOpen ? (
                    <EnhancedStateButton
                      {...(isEditing ? saveButtonPresets.update : saveButtonPresets.create)}
                    ...
                    <Button
                      ...
                      disabled={isBranchesLoading || isSubmitting || availabilityErrors.length > 0}
                      className="min-w-[120px]"
                    >
                      {isSubmitting ? (
                        <>
      ...
      <AlertDialog open={showResetConfirmation} onOpenChange={setShowResetConfirmation}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              入力された全ての情報が削除されます。この操作は元に戻せません。
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
