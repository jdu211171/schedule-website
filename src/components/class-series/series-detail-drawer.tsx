            ...
            <Tabs defaultValue="overview" className="w-full">
              ...
              <TabsContent value="overview" className="space-y-4">
                <div className="grid grid-cols-1 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        onUpdate({ teacherId: v === "none" ? null : v })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        onUpdate({ studentId: v === "none" ? null : v })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        onUpdate({ boothId: v === "none" ? null : v })
                      }
                    >
                      <SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <div>
                      {series.startDate} {series.startTime}
                    </div>
                  </div>
                  <div>
                    <div className="text-muted-foreground">End</div>
                    <div>
                      {series.endDate ?? "—"} {series.endTime}
                    </div>
                  </div>
                  <div>
              ...
              <TabsContent value="conflicts" className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-muted-foreground">
                    Teacher/Studentの可用性に基づく衝突をチェックします。
                  </div>
                  <Button
                    size="sm"
                    onClick={analyzeConflicts}
                    disabled={!canAnalyze || loadingConflicts}
                  >
                ...
                {conflictSummary && (
                  <div className="text-sm">
                    対象日数: {conflictSummary.totalRequestedDates} / 衝突:{" "}
                    {conflictSummary.conflictDates} / 利用可:{" "}
                    {conflictSummary.availableDates}
                  </div>
                )}
                <div className="space-y-2 max-h-[40vh] overflow-y-auto">
