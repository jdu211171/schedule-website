    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
        <div className="flex items-center gap-6">
          <h2 className="text-lg font-semibold text-foreground">チャンネル設定状況</h2>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-muted-foreground">全{coverage.length}校舎</span>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="border-b pb-2">
          <h3 className="text-base font-medium text-foreground">校舎別チャンネル設定詳細</h3>
          <p className="text-sm text-muted-foreground mt-1">各校舎の講師・生徒チャンネル設定状況</p>
        </div>

        <div className="space-y-2">
          {coverage.map((branch) => (
            <div key={branch.branchId} className="flex items-center justify-between p-3 rounded-lg border border-border bg-background/50 hover:bg-background/80 transition-colors">
