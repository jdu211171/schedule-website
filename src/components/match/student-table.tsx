...
export default function StudentTable({
  ...
  // Функция для проверки, есть ли у студента уроки
  const studentHasLessons = (studentId: string) => {
    return lessons.some((lesson) => lesson.studentId === studentId);
  };

  // Функция для получения предметов студента
  ...
  }, [students, grades, studentTypes, lessons, subjects]);
