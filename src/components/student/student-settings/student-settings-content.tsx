...
import StudentSettingsChangePassword from "./student-settings-change-password"
    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label>課題リマインダー</Label>
              <p className="text-sm text-muted-foreground">近日中の課題締切についてリマインダーを受け取る</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label>成績通知</Label>
              <p className="text-sm text-muted-foreground">新しい成績が投稿されたときに通知を受け取る</p>
            </div>
            <Switch defaultChecked />
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">他の生徒にプロフィールの表示を許可する</p>
            </div>
            <Switch />
          </div>
          <Separator />
...
export function StudentSettingsContent() {
  const { activeSection } = useStudentSettingsStore()
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "password":
        return <StudentSettingsChangePassword />
      case "notifications":
