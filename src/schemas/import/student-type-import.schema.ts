...
export const studentTypeImportSchema = z.object({
  ...
  maxYears: z
    ...
    .pipe(z.number().int().min(1, "最大年数は1以上の整数で入力してください").max(10, "最大年数は10以下で入力してください"))
    .default("1"),
  description: z
    .string()
...
export const STUDENT_TYPE_CSV_HEADERS = ["name", "maxYears", "description", "order"] as const;

// Required headers that must be present in the CSV
export const REQUIRED_STUDENT_TYPE_CSV_HEADERS = [
  "name"
] as const;