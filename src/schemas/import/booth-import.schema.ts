...
export const boothImportSchema = z.object({
  ...
  status: z
    ...
    .transform(val => {
      ...
      return lower === "true" || lower === "yes" || lower === "1" || lower === "はい" || lower === "有効";
    })
    .default("true"),
  branchName: z
    .string()
...
export const BOOTH_CSV_HEADERS = ["name", "status", "branchName", "order"] as const;

// Required headers that must be present in the CSV
export const REQUIRED_BOOTH_CSV_HEADERS = [
  "name",
  "branchName"
] as const;