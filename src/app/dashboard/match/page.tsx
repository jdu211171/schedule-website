...
const dummyLessons: Lesson[] = [
  {
    ...
    endTime: "09:45",
    status: "有効",
    teacherId: "clq05b5w4000014huk7hc2xg2", // Пример ID
    studentId: "clq05b5w5000114huk67mbpka", // Пример ID
  },
  {
    id: "l2",
    name: "物理演習",
    ...
    endTime: "10:45",
    status: "有効",
    teacherId: "clq05b5w4000214huk9i1a5d2", // Пример ID
    studentId: "clq05b5w5000114huk67mbpka", // Пример ID
  },
];
...
export default function LessonManagementPage() {
  ...
  const { data: subjectTypes, isLoading: subjectTypesLoading } = useSubjectTypes();
  ...
  // TODO: Добавить хук для lessons, когда он будет доступен
